    ...
    <Box className="register">
      <Paper sx={{ width: {xs:'80%' , md:"50%"}, }}>
        <Stack direction={"row"}  gap={2}>
          <Box sx={{display: {xs:'none' , lg:'block'}}} className="bgImage">
            <div
              style={{
                display: "flex",
          ...
          >
            <TextField
              ...
              error={form.name.length < 2 && accept ? true : false}
              helperText={
                form.name.length < 2 &&
                accept &&
                "It must consist of three letters or more"
              }
            />
            <TextField
              required
            ...
            <MyButton loading={loading} text={'Sign Up'}/>
